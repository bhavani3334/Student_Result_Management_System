...
$sql = "INSERT INTO student_srms(student_name, student_id, student_email_id, student_dob,student_gender, class_id, sem_id) VALUES ('$s_name', '$s_usn', '$s_email', '$s_dob', '$s_gender', '$c_id', '$sem_id')";
